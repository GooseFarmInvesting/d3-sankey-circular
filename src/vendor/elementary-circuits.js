// Vendored: elementary-circuits-directed-graph@1.3.1 (MIT, Antoine Beauchamp)
// https://github.com/antoinevastel/elementary-circuits-directed-graph
// CommonJS → ESM으로만 변환(require→import, module.exports→export default). 로직 무변경.

import tarjan from './scc.js'

export default function findCircuits(edges, cb) {
    var circuits = []; // Output
